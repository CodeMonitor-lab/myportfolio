...
export default function Testimonials() {
  ...
  return (
    <section className="relative bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-slate-200 py-28 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      {/* Background glow */}
      <div className="absolute -top-32 -left-32 w-96 h-96 bg-indigo-900/20 blur-3xl rounded-full" />
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="text-center max-w-3xl mx-auto mb-24">
          ...
          <h2 className="text-4xl md:text-5xl font-extrabold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-indigo-400 via-purple-400 to-pink-400">
            What Clients Say
          </h2>
        ...
        >
          {testimonials.map((testimonial) => (
            <motion.div
              ...
              whileHover={{ y: -8 }}
              className="group relative backdrop-blur-xl bg-white/5 border border-white/10 rounded-3xl p-8 transition-all duration-500 hover:border-indigo-500/40 hover:shadow-2xl hover:shadow-indigo-500/10"
            >
              {/* Quote mark */}
              <div className="absolute top-6 right-8 text-6xl text-indigo-500/10 font-serif select-none">
                “
              </div>
              ...
              {/* Quote */}
              <blockquote className="text-slate-300 leading-relaxed text-[15px]">
                {testimonial.quote}
              </blockquote>
