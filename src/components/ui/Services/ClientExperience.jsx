        ...
        >
          {testimonials.map((testimonial) => (
            <motion.div
              ...
              className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-8 shadow-sm dark:shadow-none transition-all duration-300 hover:border-indigo-500/40 hover:shadow-lg hover:shadow-indigo-500/10"
            >
              <div className="flex items-center gap-4 mb-6">
                ...
                />
                <div>
                  <h4 className="font-bold text-indigo-600 dark:text-indigo-400 transition-colors">
                    {testimonial.author}
                  </h4>
